package com.br.jande.pontoeletronico.controllers;
...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamentoFuncionarioIdInvalido()throws Exception{
		...
		mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
				...
				.andExpect(jsonPath("$.errors").value("Funcionario não encontrado. Id não existente."))
	...
	public void testRemoverLancamento()throws Exception{
		BDDMockito.given(lancamentoService.buscaPorId(Mockito.anyLong())).willReturn(Optional.of(new Lancamento()));
